...
public class ScheduleServiceImpl implements ScheduleService {
	...
	public void getSchedule() {
	  ...
	  // sql에 등록된 dataformat의 비교형식을 맞춰주기 위한 날짜형식 변환 작업 처리 
	  // 2023-1 -> 2023-01
	  String ym = "";
	  int intMM = mm + 1;
	...
	public List<ScheduleVO> getScheduleMenu(String mid, String ymd) {
		// 날짜 변경 처리 (2023-1-3/2023-11-3/2023-1-13 -> 2023-01-13)
		String mm = "", dd = "";
	...
	public int setScheduleUpdate(ScheduleVO vo, int idx) {
		return scheduleDAO.setScheduleUpdate(vo, idx);
	}
}
