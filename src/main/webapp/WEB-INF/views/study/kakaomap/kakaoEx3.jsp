...
<head>
	...
	<script>
		...
		/* DB 저장 처리 */
		function locationInput(latitude, longitude, address) {
	    var query = {
        		latitude : latitude,
        		longitude : longitude,
        		address : address
...
<div class="container">
	...
	<script>
		...
		function displayMarker(place) {
		    ...
		    var iwContent = '<div style="padding:5px;font-size:12px;height:60px;">' + place.place_name + '<input type="button" value="현재장소저장하기" onclick="locationInput(\''+place.y+'\',\''+place.x+'\',\''+place.place_name+'\')" /></div>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
