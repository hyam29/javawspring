  ...
  <script>
    ...
    function chartShow(part) {
    	if(part != "line" && part != "line2") {
    		...
    		location.href = 'googleChart2Recently2?part=lineChartVisitCount2';
    	}
    }
  </script>
</head>
...
<div class="container">
  ...
  <div>
    ...
    <div>
      ...
      <c:if test="${part == 'lineChartVisitCount2'}"><jsp:include page="lineChartVisitCount.jsp"/></c:if><br/><br/><br/>
      <c:if test="${part == 'lineChartVisitCount2'}"><jsp:include page="barVChartVisitCount.jsp"/></c:if>
    </div>
    <hr/>
  </div>
</div>
