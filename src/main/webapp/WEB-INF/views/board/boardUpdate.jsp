...
<div class="container">
	<form name="myform" method="post">
		...
		<table class="table table-bordered">
			...
			<tr>
				<th>글내용</th>
				<td><textarea rows="6" name="content" id="CKEDITOR" class="form-control" required>${vo.content}</textarea></td> <!-- BS에서는 textarea col 필요없음! -->
				<!--
			...
			<tr>
				<td colspan="2" class="text-center">
					<input type="button" value="수정" onclick="fCheck()" class="btn btn-outline-success" /> &nbsp;
					<input type="reset" value="재작성" class="btn btn-outline-warning" /> &nbsp;
					<input type="button" value="취소" onclick="location.href='${ctp}/board/boardList?pag=${pag}&pageSize=${pageSize}';" class="btn btn-outline-secondary" /> &nbsp;
				</td>
			</tr>
		</table>
