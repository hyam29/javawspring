...
<head>
  ...
  <script>
    ...
    /* 상품등록창에서 대분류선택(onChange)시 중분류를 가져와서 중분류 selectbox에 뿌림 */
  ...
  <div id="product">
    ...
    <form name="myform" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
      	...
      	<!-- number type으로 작성해도 됨 (여기서는 text로 받아서 위에 정규표현식으로 유효성검사 함) -->
