		...
		<ul class="pagination justify-content-center">
			...
			<c:if test="${pageVo.totPage != 0}">
			  ...
			  <c:if test="${pageVo.curBlock > 0}">
			    <li class="page-item"><a href="${ctp}/dbShop/myOrderStatus?pag=${(pageVo.curBlock-1)*pageVo.blockSize + 1}&startJumun=${startJumun}&endJumun=${endJumun}&conditionOrderStatus=${conditionOrderStatus}" title="이전블록" class="page-link text-secondary">◀️</a></li>
			  </c:if>
			  ...
			  <c:if test="${pageVo.curBlock < pageVo.lastBlock}">
			    <li class="page-item"><a href="${ctp}/dbShop/myOrderStatus?pag=${(pageVo.curBlock+1)*pageVo.blockSize + 1}&startJumun=${startJumun}&endJumun=${endJumun}&conditionOrderStatus=${conditionOrderStatus}" title="다음블록" class="page-link text-secondary">▶️</a>
			  </c:if>
